...
namespace B05ASPC13_Ecommerce2.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CatId")] Course course)
        {
            ...
            ViewData["CatId"] = new SelectList(_context.Categories, "Id", "Id", course.CatId);
            return View(course);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CatId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
